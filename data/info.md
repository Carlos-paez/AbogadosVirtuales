...
- **Derecho penal**: Defensa en procesos penales, asistencia a víctimas.
- **Derecho administrativo**: Trámites migratorios, obtención de documentación.

## ¿Cómo funciona?

1. **Registro de abogados**: Los profesionales del derecho se registran indicando su estado, jurisdicción y especialidad.
2. **Solicitud de ayuda**: Las personas afectadas completan un formulario describiendo su situación.
3. **Asignación de casos**: Nuestro sistema CRM asigna cada caso al abogado más adecuado según ubicación y especialidad.
4. **Seguimiento**: Se realiza un seguimiento continuo de cada caso hasta su resolución.
